...
__status__ = "Dev"
__desc__ = "Statistical utilities for semantic expansion: similarity score analysis (mean/std, IQR, extremes, winsorization)."
'''
...
def detect_extremes(arr: np.ndarray, top_k: int = 5) -> Dict[str, Any]:
    """
        Detect extreme similarity scores
...
def winsorize(
    ...
    """
        Apply winsorization to limit extreme similarity scores
