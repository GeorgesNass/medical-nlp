...
__status__ = "Dev"
__desc__ = "Drift utilities for icd10-prediction: statistical tests, text metrics and Evidently reporting."
'''
...
def compute_text_stats(df: pd.DataFrame) -> pd.DataFrame:
    """
        ...
        High-level workflow:
            ...
            2) Compute length and token stats
...
def generate_evidently_report(
    ...
    """
        ...
        High-level workflow:
            ...
            2) Run drift analysis (reference vs current)
...
def generate_drift_report(
    ...
    html_content = "<html><body><h1>ICD10 Drift Report</h1><pre>"
