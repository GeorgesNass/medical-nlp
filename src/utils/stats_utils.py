...
__status__ = "Dev"
__desc__ = "Statistical utilities for data quality: mean/std, IQR, extremes, winsorization."
'''
...
def detect_extremes(arr: np.ndarray, top_k: int = 5) -> Dict[str, Any]:
    """
        ...
        Args:
            arr: Input numeric array
            top_k: Number of extreme values to return

        Returns:
            Dictionary with smallest and largest values
    """
