...
__status__ = "Dev"
__desc__ = "Data quality checks for document classification: text validation, label distribution, z-score, IQR, anomaly scoring."
'''
...
def run_data_quality(
    ...
    """
        Run data quality checks for document classification dataset
    ...
    try:
        ...
        distribution = dict(zip(unique.tolist(), counts.tolist(), strict=False))

        ## detect imbalance with simple heuristic
